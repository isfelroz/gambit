...
import { HeaderPayload, SettingsPayload } from '@/types'
...
export function useHeader(initial: QueryResponseInitial<HeaderPayload>) {
	return useQuery<HeaderPayload>(headerQuery, {}, { initial })
}
